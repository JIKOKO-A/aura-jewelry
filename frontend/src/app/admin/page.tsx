    ...
    <main className="min-h-screen bg-gray-50 flex">
      ...
      <aside className="w-64 bg-background border-r border-foreground/10 flex flex-col h-screen sticky top-0">
        <div className="p-8 border-b border-foreground/10">
          <a href="/" className="font-serif text-2xl tracking-widest text-foreground font-semibold">AURA</a>
        ...
        <nav className="flex-1 py-6 flex flex-col gap-1 px-4">
          <button className="flex items-center gap-3 px-4 py-3 text-sm font-sans text-background bg-foreground rounded-sm"><LayoutDashboard size={16} /> Dashboard</button>
          <button className="flex items-center gap-3 px-4 py-3 text-sm font-sans text-foreground/70 hover:bg-foreground/5 rounded-sm"><ShoppingCart size={16} /> Orders</button>
          <button className="flex items-center gap-3 px-4 py-3 text-sm font-sans text-foreground/70 hover:bg-foreground/5 rounded-sm"><PackageSearch size={16} /> Products</button>
          <button className="flex items-center gap-3 px-4 py-3 text-sm font-sans text-foreground/70 hover:bg-foreground/5 rounded-sm"><Users size={16} /> Customers</button>
          <button className="flex items-center gap-3 px-4 py-3 text-sm font-sans text-foreground/70 hover:bg-foreground/5 rounded-sm"><BarChart3 size={16} /> Analytics</button>
        </nav>
      ...
      <div className="flex-1 p-8 md:p-12 overflow-y-auto">
        <div className="flex justify-between items-center mb-10">
          ...
          <button className="px-6 py-3 bg-foreground text-background font-sans text-xs uppercase tracking-widest hover:bg-foreground/90 transition-colors">
            Export Report
          </button>
        </div>
        ...
        <div className="bg-background border border-foreground/10 overflow-hidden">
          <div className="px-8 py-6 border-b border-foreground/10 flex justify-between items-center">
            ...
            <button className="font-sans text-xs uppercase tracking-widest text-gold hover:text-foreground transition-colors">View All</button>
          </div>
