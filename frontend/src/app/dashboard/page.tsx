...
export default function CustomerDashboard() {
  const tabs = [
    { name: "Orders & Tracking", icon: Package, active: true },
    { name: "Wishlist", icon: Heart, active: false },
    { name: "Aura Rewards", icon: Star, active: false },
      ...
      <div className="max-w-6xl w-full flex flex-col md:flex-row gap-12">
        ...
        <aside className="w-full md:w-64 flex-shrink-0">
          ...
          <nav className="flex flex-col gap-2">
            ...
            <button className="flex items-center gap-3 px-4 py-3 text-sm font-sans tracking-wide text-red-500 hover:bg-red-50 transition-colors mt-8">
        ...
        <div className="flex-1">
          <h2 className="font-serif text-2xl text-foreground mb-8">Recent Orders</h2>
          ...
          >
            ...
            <button className="mt-8 font-sans text-xs uppercase tracking-widest border-b border-foreground pb-1 hover:text-gold hover:border-gold transition-colors flex items-center gap-1">
          ...
          <div className="bg-foreground text-background p-8 flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <button className="px-6 py-3 bg-gold text-foreground font-sans text-xs uppercase tracking-widest hover:bg-gold/90 transition-colors flex-shrink-0">
              Redeem Points
            </button>
          </div>
